    ...
    post(id, accessToken, postDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data } = yield this.runInConcurrent(() => __awaiter(this, void 0, void 0, function* () {
                ...
                // @ts-ignore
                return client.v2.tweet(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, (!((_a = firstPost === null || firstPost === void 0 ? void 0 : firstPost.settings) === null || _a === void 0 ? void 0 : _a.who_can_reply_post) ||
                    ...
                    : {})), { text: firstPost.message }), (media_ids.length ? { media: { media_ids } } : {})), { made_with_ai: !!((_g = firstPost === null || firstPost === void 0 ? void 0 : firstPost.settings) === null || _g === void 0 ? void 0 : _g.made_with_ai), paid_partnership: !!((_h = firstPost === null || firstPost === void 0 ? void 0 : firstPost.settings) === null || _h === void 0 ? void 0 : _h.paid_partnership) }));
            }));
            return [
                {
                    postId: data.id,
    ...
    comment(id, postId, lastCommentId, accessToken, postDetails, integration) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { data } = yield this.runInConcurrent(() => __awaiter(this, void 0, void 0, function* () {
                var _a, _b;
                // @ts-ignore
                return client.v2.tweet(Object.assign(Object.assign({ text: commentPost.message }, (media_ids.length ? { media: { media_ids } } : {})), { reply: { in_reply_to_tweet_id: replyToId }, made_with_ai: !!((_a = commentPost === null || commentPost === void 0 ? void 0 : commentPost.settings) === null || _a === void 0 ? void 0 : _a.made_with_ai), paid_partnership: !!((_b = commentPost === null || commentPost === void 0 ? void 0 : commentPost.settings) === null || _b === void 0 ? void 0 : _b.paid_partnership) }));
            }));
            return [
                {
                    postId: data.id,
