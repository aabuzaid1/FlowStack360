...
let LoadToolsService = class LoadToolsService {
    ...
    loadTools() {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield Promise.all(toolList
            ...
            })))).reduce((all, current) => (Object.assign(Object.assign({}, all), { [current.name]: current.tool })), {});
        });
    }
    agent() {
        return __awaiter(this, void 0, void 0, function* () {
            const tools = yield this.loadTools();
            return new Agent({
                id: 'postiz',
                name: 'postiz',
...
LoadToolsService = __decorate([
    Injectable(),
    __metadata("design:paramtypes", [ModuleRef])
], LoadToolsService);
export { LoadToolsService };
