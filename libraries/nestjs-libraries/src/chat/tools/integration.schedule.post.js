...
`,
            ...
            execute: (inputData, context) => __awaiter(this, void 0, void 0, function* () {
                ...
                for (const platform of inputData.socialPost) {
                    ...
                    const { dto, maxLength, identifier } = socialIntegrationList.find((p) => p.identifier ===
                        integrations[platform.integrationId].providerIdentifier);
                    if (dto) {
                        const newDTO = new dto();
                        const obj = Object.assign(newDTO, platform.settings.reduce((acc, s) => (Object.assign(Object.assign({}, acc), { [s.key]: s.value })), {}));
