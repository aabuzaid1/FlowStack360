...
let StripeService = class StripeService {
    ...
    createEmbeddedCheckout(ud, uniqueId, customer, body, price, userId, allowTrial) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield stripe.customers.update(customer, Object.assign({ email: user.email.indexOf('@') > -1 ? user.email : `${user.email}@postiz.com` }, (body.dub
                    ? {
                        metadata: {
    ...
    getCharges(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const invoiceId of invoiceIds) {
                try {
                    const inv = yield stripe.invoices.retrieve(invoiceId);
                    if (inv.invoice_pdf) {
            ...
            return chargeList.map((charge) => (Object.assign(Object.assign({}, charge), { invoice_pdf: charge.invoice && invoicePdfMap[charge.invoice]
