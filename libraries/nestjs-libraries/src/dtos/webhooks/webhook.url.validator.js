...
export function isSafePublicHttpsUrl(value) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const records = yield dns.lookup(hostname, { all: true });
            if (!records.length) {
                return false;
            }
...
IsSafeWebhookUrlConstraint = __decorate([
    ValidatorConstraint({ name: 'IsSafeWebhookUrl', async: true })
], IsSafeWebhookUrlConstraint);
export { IsSafeWebhookUrlConstraint };
export function IsSafeWebhookUrl(validationOptions) {
