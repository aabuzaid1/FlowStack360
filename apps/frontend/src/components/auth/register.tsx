          ...
          <div className="flex flex-col">
            {!isAfterProvider &&
              (!isGeneral ? (
                ...
                <div className="gap-2 flex justify-center mb-2">
            ...
            {!isAfterProvider && (
              <div className="flex items-center gap-4 my-6 divider">
                <div className="flex-1 h-px bg-white/10" />
                <span className="text-xs font-medium text-gray-500 uppercase tracking-widest">{t('or', 'OR')}</span>
                <div className="flex-1 h-px bg-white/10" />
              </div>
            )}
            <div className="flex flex-col gap-5">
              ...
              <div className={clsx('text-[12px] text-gray-400 text-center')}>
                {t(
