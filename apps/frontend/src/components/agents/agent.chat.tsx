        ...
        style={
          {
            ...
            '--copilot-kit-border-radius': '12px',
            '--copilot-kit-user-message-bg': 'var(--new-btn-bg)',
            '--copilot-kit-user-message-text': 'var(--new-btn-text)',
          } as any
        }
        className="trz agent bg-gradient-to-br from-newBgColorInner to-newBgColor flex flex-col gap-[15px] transition-all flex-1 items-center relative rounded-2xl shadow-2xl border border-black/10 dark:border-white/10 overflow-hidden backdrop-blur-xl"
      >
        <div className="absolute left-0 w-full h-full pb-[20px]">
          <CopilotChat
            ...
            labels={{
              ...
              initial: t('agent_welcome_message', `Hello, I am your FlowStack360 AI assistant 🙌🏻.
...
const Message: FC<UserMessageProps> = (props) => {
  ...
  return (
    <div
      className="copilotKitMessage copilotKitUserMessage min-w-[300px] shadow-sm border border-black/5 dark:border-white/5 rounded-2xl bg-purple-600 text-white p-4 my-2"
...
const AssistantMessage: FC<AssistantMessageProps> = (props) => {
  ...
  return (
    <div className="copilotKitMessage copilotKitAssistantMessage min-w-[300px] shadow-sm border border-black/5 dark:border-white/5 rounded-2xl bg-white dark:bg-[#1f1f1f] p-4 my-2">
      <div
