  ...
  const secondMenu = [
    {
      ...
      icon: (
        ...
        >
          <path
            d="M10 2.16699L16.6667 5.08366V9.45866C16.6667 13.6503 13.825 17.5587 10 18.8337C6.175 17.5587 3.33333 13.6503 3.33333 9.45866V5.08366L10 2.16699Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M7.91675 10.5003L9.16675 11.7503L12.5001 8.41699"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          ...
          user?.orgId &&
            ...
            firstMenu
              .filter((f) => {
                ...
                if (f.requireSuperAdmin && !user?.isSuperAdmin) {
                  return false;
                }
