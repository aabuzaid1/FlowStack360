...
let PostActivity = class PostActivity {
    ...
    refreshTokenWithCause(integration, cause) {
        return __awaiter(this, void 0, void 0, function* () {
            const getIntegration = this._integrationManager.getSocialIntegration(integration.providerIdentifier);
            try {
                const refresh = yield this._refreshIntegrationService.refresh(integration, cause);
                if (!refresh) {
                    return false;
                }
                if (getIntegration.refreshWait) {
                ...
                yield this._refreshIntegrationService.setBetweenSteps(integration, cause);
                return false;
            }
        });
    }
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PostActivity.prototype, "refreshTokenWithCause", null);
